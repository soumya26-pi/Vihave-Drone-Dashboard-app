...
capture_index="https://25.174.224.29:8080/video"      #"http://25.14.39.28:8080/video"
...
def takeimage():
    ...
    print(prediction)
    return prediction   #render_template('result.html', prediction_text='Your disease is: {}'.format(prediction))
